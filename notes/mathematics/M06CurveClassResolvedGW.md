...
The GW structure separates a curve-class-resolved CohFT core from optional target-dependent properties such as the divisor axiom, deformation invariance, or mapping-to-a-point formulas. This keeps the algebraic gluing theory reusable while allowing stronger packages to extend it.
