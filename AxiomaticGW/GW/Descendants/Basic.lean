...
theorem ancestorClass_relabel (Omega : CurveClassGW R V B D C)
...
theorem ancestorClass_degree (Omega : CurveClassGW R V B D C)
    (P : PsiClasses C) (g : ℕ) (S : Type) [Fintype S]
...
theorem ancestorClass_eq_zero_of_negative (Omega : CurveClassGW R V B D C)
    (P : PsiClasses C) (g : ℕ) (S : Type) [Fintype S]
...
theorem ancestorClass_total_degree (Omega : CurveClassGW R V B D C)
    (P : PsiClasses C) (g : ℕ) (S : Type) [Fintype S]
    (h : StableArity g S) (beta : B) (k p : S → ℕ) (a : S → V)
...
theorem ancestorInvariant_relabel (Omega : CurveClassGW R V B D C)
    (P : PsiClasses C) (I : StableCurveIntegration C)
...
theorem ancestorInvariant_eq_zero_of_degree_ne
    (Omega : CurveClassGW R V B D C) (P : PsiClasses C)
